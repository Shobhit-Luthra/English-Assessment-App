...
- **Model choice:** Whisper `small` (CPU, int8) · Ollama `qwen2.5:3b-instruct` (later replaced by `qwen3:8b` — see `assessment-tool-fixes.md`; docs and setup now name `qwen3:8b`)
